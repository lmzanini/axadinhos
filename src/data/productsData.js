const productsData = [
  {
    ...
    description: `Seus alimentos armazenados em potes cheios de estilo;
      ...
      Feijao: 2,2 litros; 
      Macarrão: 2, 2 litros; 
      Farinha de trigo: 2,2 litros;
      Sal: 800 ml;
      Medidas dos potes de 2,2 litros: Altura 28 cm, largura 11 cm, profundidade 10 cm;
      Medida do pote de 800 ml: Altura 11,5 cm, largura 10,5 cm, profundidade 10 cm;
      Material: Acrílico;
      Cor: Transparente;
  ...
  },
  {
    ...
    description: `Resolução de captura de vídeo de vídeo de 4096*2160;
      ...
      Modo de operação de controle remoto/controle de aplicativos;
      Frequência: 2,4 Ghz;
      Giroscópio: 6 Eixos;
      Canal: 4CH;
      Método de carregamento: interface USB Universal;
      Capacidade da bateria: bateria modular 3.7V 1800mAH;
      Tempo de vôo: aproximadamente 20 minutos;
      Tempo de carregamento: 60 minutos;
      Distância de controle remoto: cerca de 150 metros;
      Modo de câmera: FPV;
      Mudança de velocidade de velocidade de mudança: lento/médio/rápido;
      Velocidade máxima de viagem: 10Km/h;
      Velocidade máxima de elevação: 3Km/h;
      Método de embalagem da embalagem: bolsa de mão;
      Material: ABS;
      Tamanho da embalagem: 21 * 6 cm;
      Tamanho do corpo: 25 * 25 * 5,5 cm (tamanho desdobrado) 12,5 * 8,3 cm (tamanho dobrado) (tamanho do corpo: 25 * 25 * 5,5 cm (tamanho desdobrado) 12,5 * 8,1 * 5,3 cm (tamanho dobrado);
      Lista de embalagem:;
      Aeronaves de aeronaves * 1;
      Transmissor remoto * 1;
      Bateria do corpo do corpo do corpo * 1;
      Cabo USB USB * 1;
      Chave de fenda * 1;
      Instruções * 1;
      Capa protetora * 4;
  ...
  },
  {
    ...
    description: `PARA O CARREGAMENTO SEM FIO FUNCIONAR, O SOM DEVE ESTAR CONECTADO NA TOMADA!! ;
      ...
      sincronizam perfeitamente com as suas melodias. Ligue a lâmpada e a música, sente-se e crie um ambiente atmosférico para relaxar.;
      
      DURMA MELHOR E ACORDE RENOVADO;
      A G-Speaker Lamp ajuda você a ter um melhor descanso com funções úteis de sono para acalmar a sua mente e corpo. No modo de sono, você pode desfrutar de uma luz noturna tranquila e calmante para adormecer suavemente. Quando chegar a hora de acordar, ela acende e ativa um despertador suave, que depois, com a função Snooze, pode lhe dar mais 9 minutos de descanso e então acordar novamente.;
  ...
  },
  {
    ...
    description: `Varal De Chão Grande
      ...
      O varal de roupa ainda conta com 2 abas nas laterais que permitem que você coloque mais de 10 cabides, e ainda possui uma barra de suporte para os sapatos. Esse varal pode suportar até 10kg por cada prateleira, lembrando que ele conta com um total de 3 prateleiras para que você possa usar para pendurar suas roupas.;
      
      Embalagem contém:;
      
      01 Varal De Roupa *desmontado*;
      
      Observações:;
      
      Pode ser colocado qualquer tipo de Roupa;
      Aguenta Até 10 Kg;
  ...
  },
  {
    ...
    description: `PRODUTOS COM GARANTIA;
      ...
      - ENVIO SUPER RÁPIDO, OS PEDIDO COM CONFIRMAÇÃO DE PAGAMENTO ANTES DAS 13H SERÃO ENVIADOS NO MESMO DIA.;
       
      
      
      Seladora a Vácuo;
      
      Na utilização da seladora a vácuo, o produto contido dentro dessas embalagens passa por um processo onde todo o ar dentro do saco e do produto é removido. Esse procedimento evita com que qualquer micro-organismo estrague seu alimento.;
      A Seladora lhe permite extrair o ar de forma controlada atingindo o nível de vácuo desejado. Preserve facilmente seus alimentos crus ou cozidos, mantendo os sabores e nutrientes de quando frescos por muito mais tempo.;
      
      
      Melhorias do Produto:;
      Bomba de vácuo reforçada para mais rapidez.;
      Selagem de Aquecimento com temperatura constante;
      Características do Produto:;
      Grau de vácuo: -60Kga.;
      Peso: 400g;
      Peso Bruto: 640g.;
      Utilizações: Peixes; Vegetais; Carnes; Frutas.;
      Voltagem: AC127v;
  ...
  },
  {
    ...
    description: `Mop Rotativo triângulo limpeza  de vidro Poeira  Auto torção Mãos Triângulo Grátis Rotativo Flat Floor Home Limpeza 360 ;
     ...
     1. O design elegante se estende por baixo e ao redor dos móveis. Remova a sujeira das áreas de difícil acesso.;
     2. As duas almofadas de microfibra reutilizáveis e reutilizáveis oferecem a oportunidade de limpeza repetida e são laváveis na máquina.;
     3.O painel com comprimento de 3,27cm é mais fácil de limpar em grandes áreas.;
     4. O design de economia de espaço pode ser armazenado verticalmente no canto, ocupando pequeno espaço e também pode ser seco rapidamente.;
     5. Aplicável a: pedra, telha cerâmica, laminado, madeira dura, vinil, bambu, cimento, placa de base e parede seca.;
     
     Características ;
     
     Faça mais fácil de limpar: A bandeja de limpeza adota o mais recente tipo de design triangular, 360° A cabeça do esfregão giratório rotativo sem poeira no canto morto, permite que você não deixe poeira no canto morto, resolva facilmente sua poeira teimosa no canto da parede, teto e janela.;
     
     Durável extremamente: Você sentirá a grande confiança com nosso esfregão ajustável, garantindo que nunca dobre ou quebrará a grande confiança com nosso esfregão ajustável, alça de aço inoxidável garantindo que nunca dobrará ou quebrará. As tiras que fixam nas almofadas do esfregão na parte inferior do quadro não se descascam depois de se molharem continuamente, construímos-as na moldura do esfregão em vez de super colá-las.;
     
     Fácil de usar: Basta prender as almofadas molhadas para baixo do quadro, ajustar e travar a alça no lugar para combinar com sua altura (máx 52 polegadas). Facilmente brisa através dos cantos mais desafiadores, nooks e crannies da sua casa. Em seguida, faça um trabalho rápido de áreas de piso aberto com nossas almofadas profissionais de esfregão.;
     
     Lavável e reutilizável: Nosso esfregão de limpeza de parede é projetado em forma de triângulo e a cabeça°, Por isso é muito fácil de limpar lugares de difícil acesso sem deixar cantos mortos. Tanto o esfregão da cabeça do triângulo quanto o pano de microfibra são laváveis na máquina e projetados para durar até centenas de lavagens sem perder a eficácia.;
     Parâmetro:;
     
     Item: esfregão triângulo;
     Tamanho: splint 27cm / retrátil 130cm;
     Material: haste de aço inoxidável + plástico ABS + esfregão de fibra;
     Cor como mostrado;
     Tamanho: Comprimento da barra do esfregão 130 cm, comprimento da placa 27 cm;
     Forma: Triângulo;
     Tipo de polo do esfregão: pólio comum + aço inoxidável da bandeja;
  ...
  },
  {
    ...
    description: `Produto com Pronta- Entrega e higienizado. Estoque no Brasil;
      ...
      - Perfeita para alimentos, ajuda reduzir a deterioração em até 5 vezes, os mantendo muito mais frescos.;
      -Pode ser utilizada para armazenar diversos outros tipos de itens, como: roupas, acessórios, joias, itens colecionáveis, etc...;
      - Uma ótima opção de ferramenta para empresas, donas de casa, e pessoas preocupadas com a durabilidade de seus produtos.;
      
      
      ESPECIFICAÇÕES:;
      
      Material: ABS;
      Tensão nominal: BIVOLT;
      Tamanho: 36 x 5,4 x 5,0 cm;
      Peso : 0,6 kg;
      Forma de trabalhar: Manual;
      Velocidade de vedação: 3 a 8seg;
      Largura Máxima de selagem: 30 cm;
      Espessura do filme: 5-13;
      Limite da pressão a vácuo: 0.08 MPa;
      Largura de selagem: 2 milímetros;
      
      CARACTERÍSTICAS:;
      
      - Não precisa de clipes, fitas ou bandas de borracha;
      - Design feito para economizar espaço, perfeito para bancada;;
      - Selagem a vácuo totalmente automática;;
      - Projeto de bomba poderosa garantindo a extração máxima de ar;;
      - Tira de calafetagem para um selo forte, seguro;;
      - Economize tempo preparando refeições com antecedência;;
      - Elimina a possibilidade de queimaduras no congelador, reduzir a deterioração e resíduos;;
      - Relacre alimentos em sua embalagem original;;
      - Protege das bactérias e fungos;
      - Selamentos hermético, mantendo o seu alimento fresco;
      - Pode manter os seus suprimentos secos enquanto estiver acampando e viajando;
      - Prevenir a prata de ficar preta;
      - Proteger fotos e documentos;
      - Ideal na cozinha, escritório, oficina, camping, jardinagem, RV, barco;
      - Serve para todas as suas comidas favoritas: chips, café, batata, passas, arroz e etc...;
      
      FUNÇÕES:;
      
      1. Semi-embalador a vácuo BIVOLT;
      2. Embalagem a vácuo e vedação;
      3. Pode ser parado durante o uso;
      4 Função de anti-sobrecarga;
      5. Fácil de desmontar e limpar;
      
      INCLUSOS:;
      
      01 x Seladora a Vácuo;
  ...
  },
  {
    ...
    description: `Descrição do produto em inglês após português;
      ...
      Descrição:;
      Temporizador de lavagem de baixa temperatura, pequenas quantidades de lavagem detergente e baixa temperatura, pode causar um aumento gradual na gordura e sujeira
      Com o tempo, esses depósitos podem danificar sua máquina e sua lavanderia.;
      Use estes comprimidos de limpeza para manter suas máquinas e mangueiras limpas. Recuperar a experiência de limpeza final, com limpeza de precisão.
      Utilizável com todas as máquinas de lavar.;
      Projetado para penetrar, dissolver e remover resíduo a base de odor, todas as máquinas de lavar
      O tablet formulado especialmente se dissolve lentamente, durado por todo o ciclo de lavagem e quebra resíduo melhor que alveja.;
      Alta eficiência para usar, seguro com máquinas de lavar lavar dianteira e grandes máquinas de lavar de carga
      Use uma vez por mês para manter a máquina fresca,;
      
      Características:;
      Desenvolvida para garantir limpeza completa da sua máquina de lavar
      Coloque simplesmente 1 comprimido no tambor, e continuar com um ciclo de lavagem;
      Limpe o filtro e as partes internas do seu aparelho, incluindo. Tambor e mangueiras
      Fórmula poderosa remove o sedimento de sujeira + resíduo detergente;
      Elimina maus odores
      Película protetora, película protetora solúvel em água para contato;
      Indicado para todas as marcas de máquina de lavar, indicado para máquinas de lavar
      Use um tablet cada mês para melhores resultados;
  ...
  },
  {
    ...
    description: `Adquira o seu Tapete Felpudo de 2,00x1,50 metros agora e experimente o que é o verdadeiro conforto e elegância.;
      ...
      Tamanho Generoso: Com dimensões de 2,00x1,50 metros, nosso tapete oferece ampla cobertura para sua sala de estar, quarto ou qualquer área de sua escolha.;
      
      Felpa Espessa: Desfrute do conforto supremo proporcionado por uma felpa espessa que é suave ao toque e oferece uma sensação de aconchego em cada passo.;
      
      Durabilidade de Longa Duração: Fabricado com materiais de alta qualidade, nosso tapete é resistente ao desgaste, garantindo que você aproveite sua beleza e conforto por muitos anos.;
      
      Design Elegante: O design sofisticado se adapta a diversos estilos de decoração, acrescentando uma pitada de classe a qualquer ambiente.;
      
      Fácil de Limpar: A manutenção é simples e descomplicada, permitindo que você preserve a aparência impecável do tapete com facilidade.;
      
      Ideal para Ambientes Diversos: Use-o na sala de estar para criar um espaço acolhedor, no quarto para dar um toque de luxo aos seus primeiros passos da manhã ou na área de lazer para momentos relaxantes.;
  ...
  },
  {
    ...
    description: `Nome do Produto: Cesto de Roupa;
      ...
      🔸Cesto de brinquedo fácil de abrir e excelente qualidade.;
      
      🔸Cor brilhante, design dobrável, limpo e arrumado.;
      
      🔸Use o cesto, pode economizar mais espaço em sua casa.;
  ...
  },
  {
    ...
    description: `✨Descrição Do Produto：;
      ...
      2,Afiação Média: Destinada á Afiação De Acabamento, Ideal Para Fachadas Que Necessitam Apenas Da Remoção De Rebarbas e Para Dar Um Acabamento Médio Aos Fios ;
      
      3,Afiação Fina:Destinada Ás Afiação De Acabamentos, Ideal Para Fachadas Que Necessitam Apenas De Uma Remoção De Vergalhões e Para Dar Um Fino Acabamento Aos Fios;
      
      ✨Produto:Amolador De Facas;
      Composição:Plastico e Metal; 
      Peso:173g;
      Contém: 1 Unidade;
      Tamanho Do Produto Sobre: 21.5*5,8*5,1cm;
      Tamanho Da Embalagem Aprox: 22*6,5*5,5cm;
      
      ✨Características:;
      - Cabo Anatômico,Com Detalhe Emborrachado; ;
      - Com Base Emborrachada Facilitando a Aderência; ;
      - Sendo Simples e Rápido De Usar,;
      
      ✨Modo De Usar: ;
      1 Posicione o Afiador Sobre Uma Base Segura e Estável, Com Uma Das Mãos Segurando Um Punho Do Afiador Sobre a Base e Com a Outra Segurando a Faca a Ser Afiada, ;
      
      2 Com o Afiador Voltado Para Você, Inicie a Afiação No Primeiro Vão Do Afiador à Sua Esquerda, Movimente a Faca Nos Dois Sentidos, ;
      
      3Continue Nas Duas Outras Posições, Seguindo a Mesma Ordem，Para Dar Acabamento à Lâmina Afiada,;
      
      4Coloque o Afiador Sobre Uma Superfície Plana e Que Não Se Movimento Durante o Uso, ;
  ...
  },
  {
    ...
    description: `PRODUTO PRONTA ENTREGA - ENVIO IMEDIATO!;
      ...
      - Flexível;
      - Não quebra;
      - Pode ser usada para doces, bolos, batata frita, frango e diferentes receitas;
       - kit com 6 tamanhos diferentes (todos na mesma cor).;
      
      Medidas Aproximadas de cada forma do kit: ;
      A - 20cm x 16cm  x 5cm;
      B - 15cm x 13cm  x 4,5cm;
      C - 14cm x 12cm  x 4cm;
      D - 13cm x 10cm  x 4cm;
  ...
  },
  {
    ...
    description: `Características:;
      ...
      -A maleta conta com peças projetadas para o dia a dia, visando a facilidade e prontidão da manutenção sem muito desgaste. A maleta é feita de termo plástico leve que não amassa e comporta muito bem o peso das ferramentas. Já o material das ferramentas é feito de aço cromo vanádio, feito para durar.;
      
      - O soquete usa aço cromado vanádio de alta qualidade 50 bv30 formação de prensa a frio, torque 50% maior que o de aço carbono, usa processamento de superfície lisa inferior, bom efeito de prevenção de ferrugem.;
      
      - A cabeça do lote adota materiais cr-v, dureza mais forte, a resistência é mais alta.;
      - Chave de catraca de queda rápida (ajustável positiva e negativa), o recurso de liberação rápida do botão de pressão garante que o soquete seja travado com segurança durante o uso, mas também permite fácil remoção ou troca rápida de soquete.;
      
      - A catraca de 45 dentes de alta qualidade pode melhorar a velocidade de operação.;
      *Pode ser usado em ar condicionado, porca de assento, para-choques, pneus, travas de porta de carro, casa (contém básico) amplamente utilizado em bicicletas, estranguladores abertos, entre outras manutenções.;
      
      Especificações:;
      
      - 46 PEÇAS.;
      - Maleta de termo plástico.;
      - Ferramentas de aço cromo vanádio.;
      - Medidas 24x13x5 (C, L, A);
      - Encaixes de 1/4 padrão sextavados.;
      
      Itens no pacote:;
      
      - 13 Soquetes ¼”:;
      - 4 mm - 4,5 mm - 5 mm - 5,5 mm - 6 mm - 7mm;
      - 8 mm - 9 mm - 10 mm - 11 mm - 12 mm - 13 mm - 14 mm;
      - 21 Soquete com Bits:;
      - Ponta Fenda: 4 mm - 5,5 mm - 7 mm;
      - Ponta Hexagonal: 3 mm - 4 mm - 5 mm - 6 mm - 7 mm - 8 mm;
      - Ponta Philips: 1 - 2 - 3;
      - Ponta POZI: 1 - 2 - 3;
      - Ponta Torx: T10 - T15 - T20 - T25 - T30 - T40;
      - 03 Chaves Hexagonais L: 1,5 mm - 2 mm - 2,5 mm;
      - 01 Cabo Fixo ¼”;
      - 02 Extensão 50 mm (2”) e Extensão 100 mm (4”);
      - 01 Extensão Flexível 150 mm (6”);
      - 01 Catraca Reversível ¼” com Quick Release: 15 x 2,7 x 2,3 cm.;
      - 01 Cabo de Força T;
      - 01 Junta Universal.;
      - 01 Bit Adaptador.;
      - 01 Maleta.;`,
  ...
  },
  {
    ...
    description: `Suporte Papel HIGIÊNICO Duplo (Para Caixa Acoplada);
      ...
      Este suporte para papel higiênico foi desenvolvido em aço cromado, que proporciona um design moderno, e é revestido por uma camada extra de um protetivo especial;
      
      A papeleira para caixa acoplada é uma ótima opção para não furar a parede, basta encaixar na caixa acoplada que já está pronta para o uso. Este modelo possui capacidade para acomodar 2 rolos de papel higiênico.;
      
      Mantenha seu banheiro lindo e organizado com os aramados.;
      Características:;
      - Material Suporte: Aço Sae 1010;
      - Suporta 2 Rolos de Papel Higiênico;
      - Encaixe para Caixa Acoplada;
      - Proporciona organização e praticidade no ambiente;
      - Prático, funcional e de fácil limpeza.;
      Dimensões e Peso:;
      - Comprimento 12,5 cm;
      - Largura 10 cm;
      - Altura 20 cm;
  ...
  },
  {
    ...
    description: `Especificações Técnicas:;
      ...
      Peso Bruto: 950 g;
      Tamanho da Embalagem: 10*10*33cm;
      Cor: Verde;
      ...
      1 Escumadeira;
      1 Colher de alinhavar;
      1 Colher de Arroz;
      1 Colher de Skimmer;
      1 Turner com fenda quadrada;
      1 Concha de sopa;
      1 Colher de espaguete;
      1 Espátula de carne;
      1 Fuê;
      1 Pinça;
      1 Pincel;
      1 Balde para armazenamento;
      Silicone resistente 480oC de calor sustentado e grau alimentício;
      
      Conjunto de Utensílios de Cozinha em Silicone e Madeira com 12 peças 4you, o melhor conjunto de utensílios para cozinha já fabricado, tem tudo que você precisa para preparar refeições incríveis. Itens projetados de forma altamente ergonômica em Madeira e Silicone resistentes a altas temperaturas, além de lindos e resistentes, são confortáveis e não transferem calor para suas mãos.;
